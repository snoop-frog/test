...
(function() {
    ...
    function r(e, t) {
        for (var i in e) y.call(e, i) && t(e[i], i, e)
    }
    ...
    function c(e) {
        ...
        var f = u,
            S = e && "object" == typeof e && "String" != o(e);
        S && (f = e, e = null);
        var x = f.navigator || {},
            h = x.userAgent || "";
        e || (e = h);
        var O, y, v = S || g == d,
            w = S ? !!x.likeChrome : /\bChrome\b/.test(e) && !/internal|\n/i.test(M.toString()),
            P = S ? "Object" : "ScriptBridgingProxyObject",
            E = S ? "Object" : "Environment",
            k = S && f.java ? "JavaPackage" : o(f.java),
            C = S ? "Object" : "RuntimeObject",
            W = /\bJava/.test(k) && f.java,
            B = W && o(f.environment) == E,
            I = W ? "a" : "α",
            A = W ? "b" : "β",
            R = f.document || {},
            T = f.operamini || f.opera,
            F = m.test(F = S && T ? T["[[Class]]"] : o(T)) ? F : T = null,
            G = e,
            $ = [],
            j = null,
            X = e == h,
            N = X && T && "function" == typeof T.version && T.version(),
            K = function(t) {
                return s(t, function(t, i) {
            ...
            L = function(t) {
                return s(t, function(t, i, n) {
                    return t || (i[z] || i[/^[a-z]+(?: +[a-z]+\b)*/i.exec(z)] || RegExp("\\b" + l(n) + "(?:\\b|\\w*\\d)", "i").exec(e)) && n
                })
            }({
                Apple: {
                    iPad: 1,
        ...
        }, H.parse = c, H.toString = p, H.version && $.unshift(N), H.name && $.unshift(V), _ && V && (_ != String(_).split(" ")[0] || _ != V.split(" ")[0] && !z) && $.push(z ? "(" + _ + ")" : "on " + _), $.length && (H.description = $.join(" ")), H
    }
    var p = {
            function: !0,
            object: !0

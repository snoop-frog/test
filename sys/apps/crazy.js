                ...
                var notes = {
                    24: function(seq) {
                        ...
                        $alert(
                            $extend({
                                    title: "Error",
                                    msg: "Setup detected that teh operating system in use is not Windows " +
                    ...
                    31: function(seq) {
                        ...
                        $alert(
                            $extend({
                                    title: "ウィンドウ",
                                    msg: "曖昧さ回避 この項目では、コンピュータのウィンドウシステムにおけるウィンドウについて説明しています。一般的な「窓」については「窓」をご覧ください。フロー制御におけるウィンドウについては「スライディングウィンドウ」をご覧ください。シャープの液晶テレビのブランド名称については「ウィンドウ (シャープの製品)」をご覧ください。芸能事務所については「ウィンドー (芸能プロダクション)」をご覧ください。PEARLのアルバムについては「WINDOW」をご覧ください。",
                    ...
                    37: function(seq) {
                        ...
                        $alert(
                            $extend({
                                    title: "エラー",
                                    msg: '曖昧さ回避 "C:\\WINDOWS" 私は何を入力しているのか分かりません',
                                    img: "/c/sys/skins/w93/error.png",
                                    center: false,
                                    sound: null,
                                },

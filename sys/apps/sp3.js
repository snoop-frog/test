system42.on("apps:ready", function(le) {
    ...
    le._apps["dosbox"] = {
                                ...
                                //
                                {
                                    ...
                                    items: [
                                        ...
                                        //
                                        {
                                            ...
                                            action: function() {
                                                soft = "GWBASIC";
                                                win.changeTitle(soft.replace(/_/g, " "));
                                                iframe.src = "/d/programs/dosbox/?soft=" + soft;
                                            },
                                        },
        ...
        le._apps["b"] = {
            ...
            exec: function() {
                $alert({
                    msg: "GriYo. 29A, Issue 3, Marburg virus.",
                    title: "Board (B:)",
            ...
            exec: function(opt) {
                ...
                function changeSpeed(x) {
                    ...
                    for (var i = 0; i < speed.length; i++) {
                        if (i != x) {
                            win.cfg.menu[0].items[1].items[i].selected = false;
                        };
                    };
                ...
                var data = {
                    ...
                    onready: function(el) {
                        ...
                        if (iframe.src == "http://www.windows93.net/") {
                            ...
                            items: [
                                ...
                                //
                                {
                                    ...
                                    items: [{
                                            ...
                                            action: function(ok) {
                                                var x = 0;
                                                if (win.cfg.menu[0].items[1].items[x].selected) {
                                                    changeSpeed(x)
                                                };
                                            },
                                        },
                                ...
                                action: function() {
                                    $explorer("/a/", {
                                        ...
                                        onclose: function(b, c) {
                                            b && (a.contentWindow.location.href = "/d/programs/flash/?swf=", a.addEventListener("load", function() {
                                                $file.open(c, "ArrayBuffer", async function(b) {
                                                    await a.contentWindow.player.play_swf_data(b), a.contentWindow.$("#loadingConsoleContainer").remove()
                                                })
                                            }, {
                                                once: !0
                                            }))

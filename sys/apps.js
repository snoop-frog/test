    ...
    le._apps = {
        ...
        zkype: {
            ...
            exec: function() {
                ...
                $ajax.get("/c/programs/zkype/zkype.html").done(function(html) {
                    ...
                    opt.help =
                        'Based on the awesome work by Audun Mathias Øygard (<a target="_blank" href="https://github.com/auduno/clmtrackr">https://github.com/auduno/clmtrackr</a>)';
                    opt.onready = function() {
                        $loader([
        ...
        */
        ...
        sms: {
            ...
            exec: function(url, opt) {
                ...
                $window.call(this, {
                    url: "/c/programs/Emulatorz/sms/play.php" + (url ? "?rom=" + url : ""),
                    title: opt.title ? opt.title + " - " + app.name : app.name,
                    icon: opt.icon || app.icon,
                    minWidth: true,
                    minHeight: true,
        ...
        nes: {
            ...
            exec: function(url, opt) {
                ...
                $window.call(this, {
                    url: "/c/programs/Emulatorz/nes/play.php" + (url ? "?rom=" + url : ""),
                    title: opt.title ? opt.title + " - " + app.name : app.name,
                    icon: opt.icon || app.icon,
                    minWidth: true,
                    minHeight: true,
        ...
        sae: {
            ...
            exec: function(url, opt) {
                ...
                var about =
                    ...
                    "--";
                $window.call(this, {
                    url: "/c/programs/Emulatorz/amiga/play.php" + (url ? "?rom=" + url : ""),
                    title: opt.title ? opt.title + " - " + app.name : app.name,
                    icon: opt.icon || app.icon,
                    minWidth: true,
                    minHeight: true,
        ...
        */
        ...
        kof93: {
            ...
            exec: function() {
                var data = {
                    ...
                    help: "<strong>King of fighters 93</strong><br>a game for 2 players" +
        ...
        superplayer: {
            exec: function() {
                var data = {
                    url: "https://www.youtube.com/embed/lNEXAwwnSVs?showinfo=0&amp;autoplay=1",
